<template>
	<div class="wrap">
		<div class="infoWrap clearfix">
			...
			<el-input class="inp" style="float: left;" v-model="userProfile.username" v-if="fileOnoff.username" :autofocus="true"></el-input>
		...
		<div class="infoWrap clearfix">
			...
			<el-input class="inp" style="float: left;" v-model="userProfile.tel" v-if="fileOnoff.tel" :autofocus="true"></el-input>
		...
		<div class="infoWrap clearfix">
			...
			<el-input class="inp" style="float: left;" v-model="userProfile.mail" v-if="fileOnoff.mail" :autofocus="true"></el-input>
